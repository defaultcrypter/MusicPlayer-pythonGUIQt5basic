...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("fuckd - Cópia.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("loop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        def abrir():
            try:
                ...
                icon.addPixmap(QtGui.QPixmap("fuckd - Cópia"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                self.pushButton_2.setIcon(icon)
            except:
                print("error!")
        ...
        if self.label_4.text() == "Play":
                    icon.addPixmap(QtGui.QPixmap("fuckd.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
                    self.pushButton_2.setIcon(icon)
        def pausar():
            if self.label_4.text() == "Play":
                try:
        ...
        def aumenta():
            ...
            vol = float(vol)
            print(vol)
            pygame.mixer.music.set_volume(vol-3.7)
            vol = pygame.mixer.music.get_volume()
